						...
						<div className="absolute right-0 mt-2 w-40 bg-card border border-border rounded-lg shadow-lg z-10">
							{languages.map((lang) => (
								<button
									...
									className={`block w-full text-left px-4 py-2 hover:bg-accent hover:text-accent-foreground rounded-lg transition-colors duration-200 ${i18n.language === lang.code
